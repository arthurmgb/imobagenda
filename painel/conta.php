        ...
        <div class="container-fluid">
          ...
          <div class="row">
            ...
            <div class="col-12 d-flex flex-row align-items-center justify-content-between flex-wrap">
              <div class="part-1 my-1">
                <a style="border-radius: 30px;" class="btn btn-lg btn-primary mr-2" href="index.php"><i class="fas fa-chevron-left mr-2"></i>Painel</a>
              </div>

              <div class="part-2 my-1">
