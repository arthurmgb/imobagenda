  ...
  <div class="content-wrapper">
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Editar Proprietário</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item active"> <a href="">Proprietários</a> / Editar Proprietário</li>
            </ol>
          </div>
        </div>
      </div>
    ...
    <div class="row mb-3">
        ...
        <?php 
           ...
           $query_select = "SELECT * FROM proprietarios WHERE id='$id'";
           $exec_select = mysqli_query($conn, $query_select);
           $value = mysqli_fetch_assoc($exec_select);
        ?>
      <div class="row mt-3">
        <div class="col-12">
        <div class="card">
            <div class="card-body">
            <form action="editar-prop.php" method="POST">
            <input type="hidden" name="id" value="<?= $id ?>">
            <div class="form-row">
            <div class="form-group col-12">
                <label>Nome completo</label>
                <input type="text" value="<?= $value['nome'] ?>" name="nome" class="form-control" required>
            </div>
            </div>
            <div class="form-row">
            ...
            <div class="form-group col-4">
                <label>Celular</label>
                <input value="<?= $value['celular1'] ?>" data-mask="(00) 0 0000-0000" name="celular1" placeholder="(00) 9 0000-0000" type="text" class="form-control" required>
            </div>
            <div class="form-group col-4">
                <label>Celular 2</label>
                <input value="<?= $value['celular2'] ?>" data-mask="(00) 0 0000-0000" name="celular2" placeholder="(00) 9 0000-0000" type="text" class="form-control">
            </div>         
            <div class="form-group col-4">
                <label>Telefone</label>
                <input type="text" value="<?= $value['telefone'] ?>" name="telefone" class="form-control">
            </div>
            </div>
