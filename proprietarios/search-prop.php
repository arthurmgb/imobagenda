      ...
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-12">
            ...
            <a style="border-radius: 30px;" class="btn btn-lg btn-success ml-2" href="new-proprietario.php"><i class="fas fa-plus-circle mr-2"></i>Novo proprietário</a> 
            <?php 
              $get_param = filter_input(INPUT_GET, 'pesquisar', FILTER_SANITIZE_STRING);
            ?>
            <form class="form-inline" action="search-prop.php" method="GET">
              <div class="form-group">
              <input type="text" name="pesquisar" class="form-control search-form pr-0" placeholder="Pesquisar..." value="<?= $get_param ?>" autofocus onfocus="var temp_value=this.value; this.value=''; this.value=temp_value">
            ...
            <div class="card-body table-responsive">
              <table class="table table-striped text-center border">
                ...
                $start = ($qtd_result * $pagina) - $qtd_result;
                 ...
                 $select_props = "SELECT * FROM proprietarios WHERE nome LIKE '%$results%' ORDER BY nome ASC LIMIT $start, $qtd_result";
