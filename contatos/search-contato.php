              ...
              <div class="d-flex flex-row flex-wrap align-items-center mb-1">
                ...
                <form action="search-contato.php" method="GET" class="flex-fill">
                  ...
                  <div class="mb-0 d-flex flex-row align-items-center">
                    <input type="text" name="pesquisar" class="form-control search-form flex-fill" placeholder="Pesquisar por proprietário" value="<?= $get_param ?>" autofocus onfocus="var temp_value=this.value; this.value=''; this.value=temp_value">
              ...
              <div class="card">
                ...
                <div class="card-body table-responsive">
                  <table class="table table-striped text-center border">
                    ...
                    $select_contatos = "SELECT c.* FROM contatos AS c JOIN proprietarios AS p ON p.id = c.id_prop WHERE p.nome LIKE '%$results%' ORDER BY p.nome LIMIT $start, $qtd_result";
