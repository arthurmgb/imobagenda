      ...
      <div class="sidebar">
        ...
        <nav class="mt-2">
          <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <li class="nav-item my-1">
              <a href="../inquilinos/inquilinos.php" class="nav-link active">
    ...
    <div class="content-wrapper">
      <div class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              <h1 class="m-0 text-dark">Visualizar Inquilino</h1>
            </div>
            <div class="col-sm-6">
              <ol class="breadcrumb float-sm-right">
                <li class="breadcrumb-item"><a href="">Inquilinos</a></li>
                <li class="breadcrumb-item active">Visualizar Inquilinos</li>
              </ol>
            </div>
          </div>
        </div>
      ...
      $view_inquilinos = "SELECT * FROM inquilinos WHERE id='$id'";
      $exec_view = mysqli_query($conn, $view_inquilinos);
        ...
        <div class="container-fluid">
          <div class="row mb-3">
            <div class="col-12 d-flex flex-row flex-wrap align-items-center justify-content-between">
              <a style="border-radius: 30px;" class="btn btn-lg btn-primary my-1" href="inquilinos.php"><i class="fas fa-chevron-left mr-2"></i>Voltar</a>

              <a style="border-radius: 30px;" class="btn btn-warning btn-lg my-1" href="edit-inquilinos.php?id=<?= $info['id'] ?>"><i class="fas fa-edit mr-2"></i>Editar</a>
            </div>
          </div>
          <div class="row">
            <div class="col-12">
            ...
            <div class="col-12">
              <div class="card">
                <div class="card-header bg-agenda">
                  <h3 class="card-title"><i class="fas fa-user-tie mr-2"></i>Perfil do Inquilino</h3>
                </div>
                <div class="card-body">
