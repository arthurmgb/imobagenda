  ...
  <div class="content-wrapper">
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Novo Inquilino</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item active"> <a href="">Inquilinos</a> / Novo Inquilino</li>
            </ol>
          </div>
        </div>
      </div>
    ...
    <div class="row mb-3">
      ...
      <div class="row mt-3">
        ...
        <div class="card">
            <div class="card-body">
            <form action="add-inqui.php" method="POST">
            <div class="form-row">
            ...
            <div class="form-group col-4">
                <label>Celular</label>
                <input data-mask="(00) 0 0000-0000" name="celular" placeholder="(00) 9 0000-0000" type="text" class="form-control" required>
            </div>
            <div class="form-group col-4">
