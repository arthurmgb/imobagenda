  ...
  <div class="content-wrapper">
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Editar Inquilino</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item active"> <a href="">Inquilinos</a> / Editar Inquilino</li>
            </ol>
          </div>
        </div>
      </div>
    ...
    <div class="row mb-3">
          <div class="col-12">
            <div class="d-flex">
              <a style="border-radius: 30px;" class="btn btn-lg btn-primary" href="inquilinos.php"><i class="fas fa-chevron-left mr-2"></i>Voltar</a>
            </div>
          </div>
        </div>
        <?php
            $id = filter_input(INPUT_GET, 'id', FILTER_SANITIZE_NUMBER_INT);
            $edit_inquil = "SELECT * FROM inquilinos WHERE id='$id'";
            $exec_edit = mysqli_query($conn, $edit_inquil);
            $edit_row = mysqli_fetch_assoc($exec_edit);
        ?>
      <div class="row mt-3">
        <div class="col-12">
        <div class="card">
            <div class="card-body">
            <form action="editar-inquilinos.php" method="POST">
            <input type="hidden" value="<?= $edit_row['id'];?>" name="id">
            <div class="form-row">
            <div class="form-group col-12">
                <label>Nome completo</label>
                <input type="text" value="<?=$edit_row['nome']?>" name="nome" class="form-control" required>
            </div>
            </div>
            <div class="form-row">
            ...
            <div class="form-group col-4">
                <label>Celular</label>
                <input data-mask="(00) 0 0000-0000" value="<?=$edit_row['celular']?>" name="celular" placeholder="(00) 9 0000-0000" type="text" class="form-control" required>
            </div>
            <div class="form-group col-4">
                <label>Celular 2</label>
                <input data-mask="(00) 0 0000-0000" value="<?=$edit_row['celular2']?>" name="celular2" placeholder="(00) 9 0000-0000" type="text" class="form-control">
            </div>         
            <div class="form-group col-4">
                <label>Telefone</label>
                <input type="text" value="<?=$edit_row['telefone']?>" name="telefone" class="form-control">
            </div>
            </div>
